...
// Общее количество бит основания decimal (целого числа, которое хранит значение decimal) (потом поменяем)
...
// Пока закоментил, так как нет других заголовочных файлов. Тут будут вызываться модули с функциями:
